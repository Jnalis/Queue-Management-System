...
ResultSet rs;
    ...
    public void select()
    {
        ...
        jTextField4.setText((String) jTable2.getValueAt(SelectedRowIndex,1));
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(663, 505));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAddActionPerformed
        String sql="INSERT INTO service(Customer_Name,Type_Of_Service,Description) VALUES (?,?,?)";
        try{
            pst = conn.prepareStatement(sql);
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "New Customer Added In Queue...!!");
            }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
        jTable2();
